# Generated by Django 4.1 on 2022-08-08 23:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_id', models.CharField(default=accounts.utils.generate_school_id, max_length=100)),
                ('user_type', models.PositiveIntegerField(choices=[(1, 'Administrator'), (2, 'Staff'), (3, 'Student')], default=1)),
                ('email', models.EmailField(blank=True, max_length=100, null=True)),
                ('profile_pic', models.CharField(blank=True, max_length=10000, null=True)),
